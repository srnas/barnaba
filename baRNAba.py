...
def parse():
    ...
    parser_01.add_argument("--per-res", dest="perres",help="Print per-residue eERMSD",action='store_true',default=False)
    ...
    parser_07.add_argument("--pdb", dest="pdbs",help="PDB file(s)",nargs="+",default=None,required=False)
    parser_07.add_argument("--trj", dest="trj",help="Trajectory",required=False,default=None)
    parser_07.add_argument("--top", dest="top",help="Topology file",required=False)
    ...
    parser_10.add_argument("--shape", dest="comp_shape",help="Compute C2-C2 fluctuations",action='store_true',default=False)
    ...
    parser_13.add_argument("--eps", dest="eps",help="epsilon used for clustering",default=0.7,type=float)
...
def main():
    ...
    # check
    if(args.subparser_name!="SMM" and args.subparser_name!="CLUSTER"):
